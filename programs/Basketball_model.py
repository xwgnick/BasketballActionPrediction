...
class Basketball_model:
    ...
    def dataset_importing(self, dataset_dir):
        ...
        self.datasets_testing.append(Dataset(dataset_dir + '/dataset_20150320.csv', "20150320", home_visit = 1, shuffle = False, standardize = False, normalize = True))
...
#        for i in range(1):
    ...
    def model_evaluate(self, sample):
        ...
        diff_label_number = {'touch': 0, 'dribble': 0, 'pass': 0, "shot": 0, "rebound":0, "free throw":0, "turnover":0}
        erro_rate = {'touch': 0, 'dribble': 0, 'pass': 0, "shot": 0, "rebound":0, "free throw":0, "turnover":0}
